  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Brand colors
        brand: {
          DEFAULT: '#005659',  // header/footer/sidebar
          dark:    '#004545',  // darker shade for footer/hover
          light:   '#007775',  // accents/lighter elements
        },
        
        // Primary brand colors (keeping existing for compatibility)
        primary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
